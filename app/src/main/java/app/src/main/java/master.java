...
public class master extends helpers {
...

            {
                ...
                default:
                    if (input.equals("/exit")) {
                        ...
                        System.out.println(
                                "\u001B[33m" + "Invalid command! Type /help for a list of commands." + "\u001B[0m");
                    }
                    break;
            }
    ...
    /*
     * guessGUI
     * param: String guessedWord, String baseWord, List<String> acceptedWords,
     * String playerRank
     * returns: N/A
    ...
    public static void intro() {
        ...
        System.out.println(
                yellowColor + "/savepuzzle" + resetColor + ":  Save the current puzzle for later without game status.");
