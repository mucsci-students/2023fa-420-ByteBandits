...
public class CliGameModel extends helpers {
    ...
    public static void savePuzzle() throws Exception {
        ...
        saveFile.saveGameData(getSaveFileName(), baseWord, shuffleWord, foundWords, totalPoints,
                String.valueOf(reqLetter), possiblePoints, author, acceptedWordList, encrypt);
