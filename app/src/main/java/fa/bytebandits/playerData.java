package app.src.main.java.fa.bytebandits;
import java.io.*;
...
public class playerData {
    ...
    public void saveGameData(String baseWord, List<String> foundWords, int playerPoints, String requiredLetter, int maxPoints) {
        try (FileWriter fileWriter = new FileWriter("app\\src\\main\\java\\fa\\bytebandits\\game_data.json")) {
    ...
    public void loadGameData() {
        try (BufferedReader reader = new BufferedReader(new FileReader("app\\src\\main\\java\\fa\\bytebandits\\game_data.json"))) {
